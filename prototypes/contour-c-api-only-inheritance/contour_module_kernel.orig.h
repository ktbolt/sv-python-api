...
{
    std::cout << "######### ContourKernelGetType ##########" << std::endl;
    return PyUnicode_FromString("circle");
    //return self->circle;
}

int
ContourKernelSetType(ContourKernelObject* self, PyObject *value) {
    return 0; 
}

static PyGetSetDef ContourKernelGetSets[] = 
{
  {(char*)"circle", (getter)ContourKernelGetType, (setter)ContourKernelSetType, NULL, NULL},
  {NULL}
};
...
PyInit_kernel(void)
{
  ...
  PyModule_AddObject(module, "contour.kernel", (PyObject*)&ContourKernelType);
